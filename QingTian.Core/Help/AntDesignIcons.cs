...
namespace QingTian.Core
{
    ...
    {
        static string[] icons = {"account-book-filled",
        ...
        /// 随机图标
        /// </summary>
        public static string RandomIcon => $"ant-design:{icons[random.Next(icons.Length - 1)]}";
        public static string Add => "ant-design:file-add-outlined";
        public static string Edit => "ant-design:edit-outlined";
        public static string Delete => "ant-design:delete-outlined";
        public static string Search => "ant-design:search-outlined";
        public static string Detail => "ant-design:profile-outlined";
    }
}
